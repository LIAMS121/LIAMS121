                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <table class="table">
                                                                        ...
                                                                        <thead>
                                                                            ...
                                                                            <th>Email</th>
                                                                        <tbody>
                                                                            <?php require_once "includes/customers.php" ?>


                                                                            <tr>
                                                                                <?php foreach ($statement as $d => $details) : ?>

                                                                                    <td>
                                                                                        <div class="td">

                                                                                            <?php echo $details['fullname'] ?></div>
                                                                                    </td>
                                                                                    <td>
                                                                                        <div class="td"><?php echo $details['phone'] ?></div>
                                                                                    </td>
                                                                                    <td>
                                                                                        <div class="td"><?php echo $details['email'] ?></div>
                                                                                    </td>
                                                                            </tr>
                                                                        <?php endforeach; ?>
                                                                        </tbody>
