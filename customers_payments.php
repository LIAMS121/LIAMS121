                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            <?php foreach ($statement as $i => $import) : ?>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td>&#8358;
                                                                                        <?php
                                                                                        if ($import['payment_status'] === "Full Payment") {
                                                                                            $amount_paid = $import['price'];
                                                                                            $id = $import['id'];
                                                                                            $sqlUpdate = "UPDATE measurement SET amount_paid=:amount WHERE id=:id";
                                                                                            $statement = $connection->prepare($sqlUpdate);
                                                                                            $statement->bindvalue(":amount", $amount_paid);
                                                                                    ...
                                                                                    <td><?php echo ($import['payment_status']) ?> </td>
                                                                                    <td>&#8358;<?php if ($import['payment_status'] !== "Full Payment") {
                                                                                                    $id = $import['id'];
                                                                                                    $balance = $import['price'] - $import['initial_payment'];
                                                                                                    $sqlUpdate = "UPDATE measurement SET balance=:balance WHERE id=:id";
                                                                                                    $statement = $connection->prepare($sqlUpdate);
                                                                                                    ...
                                                                                                    echo number_format($balance, 2);
                                                                                                        ...
                                                                                                        ?></td>
                                                                                    <td><button class="btn btn-primary"><a href="manage_payments.php?id=<?php echo $import['id'] ?>" class="text-white">View Details</a></button></td>
                                                                                </tr>
                                                                        </tbody>
                                                                    <?php endforeach; ?>
                                                                    </table>
